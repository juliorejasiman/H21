...
INSERT INTO Venta
 (TOTVENT, CANPROVENT, FECVEN, DNIADM, CODSUC, DNIVEN, DNIJEF, DNIDES)
	VALUES


('20.50','1','21/07/10', '70245673','1','15245673','71245645','75022476'),
('30.50','8','21/08/14', '70245673','2','14275873','78275873','77023450'),
('25.50','2','21/09/18', '70245673','3','15245643','73244160','72021444'),
('35.50','3','21/05/15', '70245673','1','15245673','73244160','72021444'),
('15.50','1','21/03/01', '70245673','2','14275873','73244160','72021444'),
('10.50','2','21/05/17', '70245673','3','15245643','73244160','72021444')
GO
...
CREATE VIEW vwDespachadores
AS
SELECT 
(DE.NOMDES) + ', ' + (DE.APEDES) AS 'Despachador',
	V.FECVEN AS 'Fecha de Venta',
	V.CANPROVENT AS 'Pizzas Vendidos',
	DEST.DIRDES AS 'Direccion del destino'
FROM dbo.Despachadores AS DE
INNER JOIN dbo.Venta AS V
ON DE.DNIDES = DE.DNIDES
INNER JOIN dbo.Destino AS DEST
ON DEST.DIRDES = DEST.DIRDES
GO